...
// import { AmentiesState, newMeetingRoomRequest } from "../../meetingRoomStore";
                ...
                {amenitiesData.map((amenity, index) => (
                    <div key={index} className="flex p-6 justify-between items-center">
                        ...
                        <div className="border w-fit rounded-lg overflow-hidden flex items-center">
                            <label className={amenity.toggle ? "bg-primary px-2 py-2" : "px-2 py-2"}>
                                <input
                                    key={"toggle" + index}
                                    className="absolute hidden "
                                    type="radio"
                                    value="toggle"
                                    checked={amenity.toggle}
                                    onChange={() => handleQuantityToggle(index, "toggle")}
                                />
                                <span className="text-base text-dark  ">Toggle</span>
                            </label>
                            <label className={!amenity.toggle ? "bg-primary font-xs px-2 py-2" : "px-2 py-2"}>
                                <input
                                    key={"quantity" + index}
                                    type="radio"
                                    value="quantity"
