...
function WorkshopRequests() {
    ...
    return (
        <div className="workshop-requests">
            <Breadcrumbs />
            <div className="WorkshopRequests grid grid-cols-6 gap-6 h-fit">
                <div className="col-span-2 h-fit">
                    ...
                    <div className="RequestList flex-col relative shadow-md flex border rounded-2xl p-4 max-h-[70vh] overflow-auto">
                        {listItems}
                    </div>
                </div>

                <div className="RequestBody relative shadow-md border rounded-2xl px-8 py-12 col-span-4 h-full">
